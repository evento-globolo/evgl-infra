...
Secrets for `evento-globolo/evgl-infra` are **committed, encrypted**, with [sops] + [age],
...
```sh
just env-docker-run dev ghcr.io/evento-globolo/evgl-infra:dev
