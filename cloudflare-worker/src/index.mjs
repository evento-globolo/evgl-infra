...
const PRODUCT = Object.freeze({"org": "evento-globolo", "name": "Evento Globolo", "tagline": "One global event system for discovery, management, automation, and cross-posting.", "audience": "event organizers, venues, communities, promoters, attendees, and integration partners", "integrations": ["Meta/Facebook Events", "Eventbrite", "Meetup", "Craigslist", "LinkedIn Events", "Calendar feeds"], "capabilities": ["event-catalog", "cross-posting", "webhooks", "oauth-connections", "events", "audit"]});
